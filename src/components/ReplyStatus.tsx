...
export function ReplyStatus({ replySentAt, replyTemplateId, variant = 'badge' }: ReplyStatusProps) {
  ...
  return <ReplyStatusDetailed status={status} replySentAt={replySentAt} replyTemplateId={replyTemplateId} />;
}
...
export function ReplyStatusFilter({ 
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="text-sm font-medium text-gray-700">Filter by reply status:</span>
