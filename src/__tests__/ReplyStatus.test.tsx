...
import { ReplyStatus, ReplyStatusFilter, getReplyStatus } from "@/components/ReplyStatus";
...
describe("ReplyStatus Detailed Variant", () => {
  ...
  it("shows pending message when template assigned but not sent", () => {
    ...
    expect(screen.getByText(/Template assigned, awaiting send/)).toBeInTheDocument();
  });
});
