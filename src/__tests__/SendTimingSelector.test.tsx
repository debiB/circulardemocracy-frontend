...
import { SendTimingSelector, getTimingDisplayLabel } from "@/components/SendTimingSelector";
...
describe("SendTimingSelector", () => {
  ...
  it("displays correct description for office_hours timing", () => {
    ...
    expect(
      screen.getByText(/Messages will be sent during office hours \(8:00–19:00 CEST\)/),
    ).toBeInTheDocument();
  });
...
describe("getTimingDisplayLabel", () => {
  ...
  it("returns formatted label for scheduled timing with date", () => {
    const result = getTimingDisplayLabel(
      "scheduled",
